---
title: "Workshop Exercise: Emissions Data - Table, Map, and Chart - Lea Adams"
format: html
---
...
selected_countries = ['Albania', 'Austria', 'Andorra', 'Angola', 'Australia']
emissions_long_subset = emissions_long[
    emissions_long['country'].isin(selected_countries)]
...
fig_chart = px.line(
    ...
    labels={"year": "Year", "emissions": "Emissions", "country": "Country"}
)
fig_chart
```
